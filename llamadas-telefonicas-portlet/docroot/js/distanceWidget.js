...
function DistanceWidget(opt_options) {
	...
	// Bind to the radius widget active property
	this.bindTo('active', radiusWidget);
	
	var me = this;
	google.maps.event.addListener(marker, 'dragstart', function() {
		me.set('dragstart', true);
		me.set('dragend', false);
	});

	google.maps.event.addListener(marker, 'dragend', function() {
		me.set('dragend', true);
		me.set('dragstart', false);
	});
...
RadiusWidget.prototype.getSnappedPosition_ = function(pos) {
	...
	var right = new google.maps.LatLng(center.lat(), bounds.getNorthEast()
			.lng());
