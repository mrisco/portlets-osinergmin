package org.innovate.osinergmin.llamadas.telefonicas;
...
/**
 * Portlet implementation class LlamadasTelefonicas
 */
public class LlamadasTelefonicas extends MVCPortlet {
  private static Log _log = LogFactoryUtil.getLog(LlamadasTelefonicas.class);
  ...
  private void generarExcel(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
    ...
    resourceResponse.setProperty("Content-Disposition", "attachment; filename=ListadoLlamadas.xls");

    String[] cabecera = { "SED", "Nombre-SED", "Empresa" };
